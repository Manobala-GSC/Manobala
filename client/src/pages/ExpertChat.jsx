                                ...
                                <div className="flex items-start">
                                  ...
                                  <div>
                                    ...
                                    <div className="flex flex-col items-start mt-1 gap-1">
                                      ...
                                      {chat.expert.specialization && (
                                        <span className="text-xs px-2 py-1 bg-purple-100 text-purple-600 rounded-full flex items-center">
                                          {chat.expert.specialization}
                                        </span>
                                      )}
                                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="flex flex-col items-start gap-1 mt-1">
                          ...
                          {!userData?.isExpert && currentChat.expert?.specialization && (
                            <span className="text-xs px-2 py-0.5 bg-purple-100 text-purple-600 rounded-full">
                              {currentChat.expert.specialization}
                            </span>
                          )}
                        </div>
                      </div>
